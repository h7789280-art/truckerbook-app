...
export default function Fuel({ userId, refreshKey, profile, filterVehicleId, userRole, vehicles, isAllVehicles, initialCategory, onOpenSmartScan, onOpenAddModal }) {
  ...
  const role = profile?.role || userRole || 'owner_operator'
    ...
    <div style={{ padding: '16px', minHeight: '100vh' }}>
      ...
      {showQuickAdd && (
        <div style={{ display: 'flex', gap: '8px', marginBottom: '16px' }}>
          ...
          {onOpenSmartScan && (
            <button
              onClick={() => onOpenSmartScan(t('smartScan.hints.vehicleExpense'))}
              style={{
                flex: 1,
                padding: '12px',
                borderRadius: '12px',
